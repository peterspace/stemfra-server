...
// Flagship demo per vertical, keyed by canonical DB slug (verticalConfig normalizes any input form).
const FLAGSHIP = {
  barbershops:  'https://rourke-sloane.stemfra.com',          // Manhattan theme
  salons:       'https://linden-lark.stemfra.com',            // Sorrel theme
...
function resolveDemoLink(slug) {
  if (!slug) return null;
  return FLAGSHIP[resolveVerticalSlug(slug)] || null;
}
