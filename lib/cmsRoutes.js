...
const CMS_ROUTES = {
  ...
  // The standalone Booking + Service-pricing settings sections were removed in
  // the 2026-08 UI polish (pricing display now lives INSIDE the Payments
  // section) — both point at the live #payments anchor so nothing dead-links.
  booking: '/settings/payments#payments',
  pricingDisplay: '/settings/payments#payments',
