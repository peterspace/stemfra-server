...
async function buildOnboardingChecklist(siteId) {
  ...
  const GOAL_STEPS = {
    bookings: ['services_desc', 'services_photos', 'hours'],
    memberships: ['services_desc', 'services_photos'],
    getfound: ['seo', 'social', 'contact'],
    showcase: ['team_photos', 'services_photos', 'about', 'hero'],
    brand: ['logo', 'hero'],
    payments: [],
  };
  ...
  const steps = [
    ...
    { key: 'hero', kind: 'personalize', label: 'Personalize your homepage headline', hint: 'Make the first thing visitors see your own — I can draft it for you.', route: CMS_ROUTES.homeContent, draftable: true },
    ...
    { key: 'about', kind: 'personalize', label: 'Tell your story on the About page', hint: 'Your story builds trust — I can draft it from your details.', route: CMS_ROUTES.aboutContent, draftable: true },
    { key: 'contact', kind: 'personalize', label: 'Add your contact details', hint: 'Address, phone and email so customers can reach you.', route: CMS_ROUTES.homeContent },
    { key: 'hours', kind: 'personalize', label: 'Set your opening hours', hint: 'Double-check your opening hours are right.', route: CMS_ROUTES.hours },
    { key: 'seo', kind: 'fill', label: 'Add search descriptions to your pages', hint: 'A short description per page for Google — I can draft these.', route: CMS_ROUTES.homeContent, draftable: true, auto: allHave(pubPages, (p) => !!p.meta_description) },
