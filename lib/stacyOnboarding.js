...
async function buildOnboardingChecklist(siteId) {
  ...
  const steps = [
    ...
    { key: 'hero', kind: 'personalize', label: 'Personalize your homepage headline', hint: 'Make the first thing visitors see your own. I can draft it for you.', route: CMS_ROUTES.homeHero, draftable: true },
    ...
    { key: 'contact', kind: 'personalize', label: 'Add your contact details', hint: 'Address, phone and email so customers can reach you.', route: CMS_ROUTES.homeContact },
