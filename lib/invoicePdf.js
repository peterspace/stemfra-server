...
// Stream a one-page invoice PDF to `res`. Caller has already auth'd + verified
// the charge belongs to this owner.
function streamInvoicePdf(res, { charge, contact, billingProfile = {}, provider }) {
...
module.exports = { streamInvoicePdf, invoiceNumber };
