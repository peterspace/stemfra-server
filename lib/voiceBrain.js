    ...
    const r = await openai.chat.completions.create({
      ...
      messages: [
        { role: 'system', content: [
          ...
          '"intent" is "support" when the caller is an EXISTING Stemfra customer asking about THEIR account/website (password, their bill, a site issue, cancelling); "sales" when they are a prospect asking about getting a website/plans; else "other".',
          ...
          '"sentiment" is the CALLER\'s overall tone. "plan_discussed" is a plan name (Essential/Growth/Pro) if one was discussed, else null.',
