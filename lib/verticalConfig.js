...
const VERTICALS = {
  ...
  // Seed = the `lull` site (was `calm-roots-massage`; renamed 2026-07, and the old
  // subdomain is dead). Keying on the UUID is why that rename cost nothing here.
  // Cloned from the yoga seed (generated UUID, not a
  ...
  // Spa deployed 2026-07-07 (Pages project 'stemfra-spa' live). Seed = ellaris-spa
  // (the spa flagship demo). boutique_gyms retired 2026-07-04 (replaced by the
  // wellness pillar); its inactive DB row remains.
  spa:          { project: 'stemfra-spa',      seedSite: '4a72b46f-f16f-435d-a9b1-f3718c68ac54', leadgen: 'spa',          aliases: ['spas', 'day_spa', 'spa_wellness'] },
};
