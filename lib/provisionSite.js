...
// Every slug form in the stack → the canonical DB verticals.slug. The lead-gen
// KNOWN_VERTICALS (barbershop/beauty_salon/boutique_gym) and the marketing site
// (barbers/salon/yoga) all differ from the DB plural/underscore form, so without
// these, onboarding a lead-gen "beauty_salon" lead would fail to find a seed.
const VERTICAL_ALIASES = {
  barbers: 'barbershops', barbershop: 'barbershops', barbershops: 'barbershops',
  salon: 'salons', salons: 'salons', beauty_salon: 'salons', beauty_salons: 'salons', beauty: 'salons',
  crossfit: 'crossfit',
  yoga: 'yoga_pilates', pilates: 'yoga_pilates', yoga_pilates: 'yoga_pilates',
  gyms: 'boutique_gyms', boutique_gym: 'boutique_gyms', boutique_gyms: 'boutique_gyms',
};
