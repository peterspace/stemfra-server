...
async function markRequested(chargeId, { externalRef = null, by = null } = {}) {
  ...
  // Mirror the invoice into Airwallex Billing (best-effort, fire-and-forget —
  // official OUT_OF_BAND invoice; builds KYB trading history; see
  // lib/airwallexBilling.js).
  try { require('../airwallexBilling').mirrorInvoice(chargeId).catch(() => {}); } catch { /* mirror optional */ }
  return data;
}
