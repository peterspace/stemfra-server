  ...
  return {
    company: {
      ...
      differentiators: [
        ...
        'Every site gets a free yourname.stemfra.com address; you can buy your own domain in the dashboard (priced yearly, invoiced like everything else) or connect one you already own.',
      ],
    },
    ...
    pricing: {
      ...
      included_free: [
        'A hand-designed, mobile-first website built for your industry, on a free yourname.stemfra.com address (your own domain can be bought or connected)',
    ...
    how_it_works: [
      ...
      'Publish to go live on your free stemfra.com address, or your own domain. You can keep your current system and switch at your pace.',
