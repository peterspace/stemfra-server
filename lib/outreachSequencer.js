...
const { timezoneForLead, localHour } = require('./leadTimezone');
...
async function sweepOnce() {
  ...
  // Reviewer-approved, scheduled touch-1 sends go out regardless of the
  // auto-drip master switch (they are explicit staff actions, just time-shifted).
