...
const { send, completeBooking, rewind } = require('../controllers/siteChatController');
...
router.post('/rewind', rewind); // "Rewind to here": truncate the transcript so the agent forgets too
